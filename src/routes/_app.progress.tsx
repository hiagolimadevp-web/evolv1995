    ...
    <div className="flex flex-col gap-6 px-5 pt-12">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="card-surface p-4">
          ...
          <div className="mt-1 text-xs text-muted-foreground">Goal {profile?.goalWeightKg ?? "—"} kg</div>
        </div>
        <div className="card-surface p-4">
          ...
          <div className="mt-1 text-xs text-muted-foreground">Healthy trend</div>
        </div>
        <div className="card-surface col-span-2 flex items-center gap-4 p-4">
          ...
          <div>
            ...
            <div className="text-xs text-muted-foreground">{t("keepGoing")}</div>
          </div>
        </div>
      </div>
      <div className="card-surface p-5">
        <div className="text-sm font-semibold">Charts, photos & measurements</div>
        <p className="mt-1 text-xs text-muted-foreground">{t("comingSoonSub")}</p>
      </div>
    </div>
  );
}